...
namespace Flatcode.Presentation
{
    ...
    public class TaskDialog : DependencyObject
    {
        ...
        {
            activatedEventHandler?.Invoke(this, e);
        }
        ...
        {
            closedEventHandler?.Invoke(this, e);
        }
        ...
        {
            collapsedEventHandler?.Invoke(this, e);
        }
        ...
        {
            expandedEventHandler?.Invoke(this, e);
        }
        ...
        {
            helpEventHandler?.Invoke(this, e);
        }
        ...
        {
            initializedEventHandler?.Invoke(this, e);
        }
        ...
        {
            timerEventHandler?.Invoke(this, e);
        }
        ...
        {
            verificationChangedEventHandler?.Invoke(this, e);
        }
